resource "google_dns_record_set" "ops-manager-dns" {
  name = "pcf.${var.env_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "optional-ops-manager-dns" {
  name  = "pcf-optional.${var.env_name}.${var.dns_name}"
  type  = "A"
  ttl   = 300
...
resource "google_dns_record_set" "wildcard-sys-dns" {
  name = "*.sys.${var.env_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "doppler-sys-dns" {
  name = "doppler.sys.${var.env_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "loggregator-sys-dns" {
  name = "loggregator.sys.${var.env_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "wildcard-apps-dns" {
  name = "*.apps.${var.env_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "wildcard-ws-dns" {
  name = "*.ws.${var.env_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "app-ssh-dns" {
  name = "ssh.sys.${var.env_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "tcp-dns" {
  name = "tcp.${var.env_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
